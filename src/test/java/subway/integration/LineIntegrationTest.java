...
class LineIntegrationTest extends IntegrationTest {
    ...
    void createLine() {
        // given
        Long stationRequest1 = createStation(new UpdateStationRequest("역1")).body().as(StationResponse.class).getId();
        Long stationRequest2 = createStation(new UpdateStationRequest("역2")).body().as(StationResponse.class).getId();
        UpdateLineRequest lineRequest1 = new UpdateLineRequest("노선1", "bg-red-600", stationRequest1, stationRequest2, 10);
    ...
    void getLines() {
        ...
        Long stationRequest1 = createStation(new UpdateStationRequest("역1")).body().as(StationResponse.class).getId();
        Long stationRequest2 = createStation(new UpdateStationRequest("역2")).body().as(StationResponse.class).getId();
        Long stationRequest3 = createStation(new UpdateStationRequest("역3")).body().as(StationResponse.class).getId();
        UpdateLineRequest lineRequest1 = new UpdateLineRequest("노선1", "bg-red-600", stationRequest1, stationRequest2, 10);
    ...
    void createSectionOnLineMiddleStationByUpStation() {
        ...
        Long stationRequest2 = createStation(new UpdateStationRequest("역2")).body().as(StationResponse.class).getId();
        Long stationRequest3 = createStation(new UpdateStationRequest("역3")).body().as(StationResponse.class).getId();
        Long stationRequest4 = createStation(new UpdateStationRequest("역4")).body().as(StationResponse.class).getId();
        UpdateLineRequest lineRequest1 = new UpdateLineRequest("노선1", "bg-red-600", stationRequest1, stationRequest2, 10);
